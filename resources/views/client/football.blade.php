...
<script>
  ...
  $(document).ready(function() {
    ...
    function fetchGameData() {
      $.ajax({
        url: "{{ route('football_games_api') }}", // Your route here
        type: 'GET',
        dataType: 'json',
        ...
        <div class="row td-body" tabindex="0">
          <div class="col-md-4 col-lg-5 col-6 cursor">
            <a href="{{ route('Football-Details', '') }}/${r.id}">
              <p>${r.game_title}<span>&nbsp;/&nbsp;</span><b>${r.run_date_time}</b></p>
            </a>
          </div>
            ...
            <a href="{{ route('Football-Details', '') }}/${r.id}">
              <div class="list-event-odds">
                <div class="btn-grp-cs">
                  ...
                  <button class="lay"><span class="odd">1.01</span></button>
                </div>
                <div class="btn-grp-cs">
                  <button class="back"><span class="odd">1000</span></button>
