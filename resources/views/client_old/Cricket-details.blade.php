...
<head>
  ...
  <style>
    ...
    .flex-child[_ngcontent-uhn-c75] {
      width: 50%;
      text-align: center;
      background-color: #bb1919
    }

    .flex-child[_ngcontent-uhn-c75]:nth-child(2) {
      background-color: #8a1538
    }

    .flex-child__content[_ngcontent-uhn-c75] {
      display: inline-block;
    ...
    .top-nav-event[_ngcontent-uhn-c75] {
      background: #1a5684 !important;
      scrollbar-width: 0 !important
    }

    .top-nav-event[_ngcontent-uhn-c75]::webkit-scrollbar {
      width: 0 !important;
      background: #0000 !important;
      display: none !important
    }

    .bg-color[_ngcontent-uhn-c75] {
      background: #101450 !important
    }
  </style>
  <style>
    b[_ngcontent-uhn-c72] {
      font-weight: 400 !important
    }

    .searchAnchor[_ngcontent-uhn-c72] {
      color: #000 !important
    }

    .searchAnchor[_ngcontent-uhn-c72]:hover {
      color: #fff !important
    }

    .game-date[_ngcontent-uhn-c72],
    .search-game-name[_ngcontent-uhn-c72] {
      float: left;
      width: 50%
    }

    .game-teams[_ngcontent-uhn-c72] {
      width: 100%;
      float: left
    }

    .searchM[_ngcontent-uhn-c72] .search[_ngcontent-uhn-c72] {
      position: absolute;
      margin: auto;
      top: 0;
      right: 0;
    ...
    .searchM[_ngcontent-uhn-c72] .search[_ngcontent-uhn-c72]:hover {
      cursor: pointer
    }

    .searchM[_ngcontent-uhn-c72] input[_ngcontent-uhn-c72] {
      position: absolute;
      margin: auto;
      text-align: left;
      top: 0;
    ...
    .searchM[_ngcontent-uhn-c72] input[_ngcontent-uhn-c72]:hover {
      cursor: pointer
    }

    .searchM[_ngcontent-uhn-c72] input[_ngcontent-uhn-c72]:focus {
      width: 200px;
      opacity: 1;
      cursor: text
    }

    .searchM[_ngcontent-uhn-c72] input[_ngcontent-uhn-c72]:focus~.search[_ngcontent-uhn-c72] {
      right: -360px;
      background: #fff;
      z-index: 6
    }

    .searchM[_ngcontent-uhn-c72] input[_ngcontent-uhn-c72]:focus~.search[_ngcontent-uhn-c72]:before {
      top: 0;
      left: 0;
      width: 25px
    }

    .searchM[_ngcontent-uhn-c72] input[_ngcontent-uhn-c72]:focus~.search[_ngcontent-uhn-c72]:after {
      top: 0;
      left: 0;
      width: 25px;
      height: 2px;
    ...
    .searchM[_ngcontent-uhn-c72] input[_ngcontent-uhn-c72]::placeholder {
      color: #000;
      opacity: .5;
      font-weight: bolder
    }
  ...
  <style>
    .collapse[_ngcontent-uhn-c73] {
      cursor: pointer
    }
  </style>
  <style>
    .betCounts[_ngcontent-uhn-c91] .matched[_ngcontent-uhn-c91],
    .betCounts[_ngcontent-uhn-c91] .unmatched[_ngcontent-uhn-c91] {
      min-width: 25px;
      width: auto;
      padding: 0 5px
    }

    .min-max[_ngcontent-uhn-c91] {
      float: right;
      color: #ef4e46;
      font-size: 13px;
      padding: 12px;
    ...
    .min-max[_ngcontent-uhn-c91] span[_ngcontent-uhn-c91] {
      margin-right: 5px
    }

    .position-relative[_ngcontent-uhn-c91] {
      position: relative
    }

    .event-title[_ngcontent-uhn-c91] {
      display: flex;
      justify-content: space-between
    }

    .mobile-sec[_ngcontent-uhn-c91] {
      position: relative
    }

    .mobile-sec[_ngcontent-uhn-c91] a.tv[_ngcontent-uhn-c91] {
      top: 9px
    }

    .mobile-sec[_ngcontent-uhn-c91] a.tv[_ngcontent-uhn-c91] i[_ngcontent-uhn-c91] {
      color: #464646
    }

    .no-dt[_ngcontent-uhn-c91] {
      background: #f2f2f2;
      border-bottom: 1px solid #fff;
      text-align: center
    }

    .no-dt[_ngcontent-uhn-c91] p[_ngcontent-uhn-c91] {
      padding: 5px 0;
      margin: 0
    }
    ...
    .horse-detail[_ngcontent-uhn-c91] .country-name[_ngcontent-uhn-c91] {
      padding-top: 3px;
      padding-bottom: 3px
    }

    .horse-detail[_ngcontent-uhn-c91] .country-name[_ngcontent-uhn-c91] label[_ngcontent-uhn-c91] {
      display: flex;
      flex-wrap: wrap;
    ...
    .horse-detail[_ngcontent-uhn-c91] .country-name[_ngcontent-uhn-c91] label[_ngcontent-uhn-c91] img[_ngcontent-uhn-c91] {
      height: 25px;
      margin-right: 5px;
      border-radius: 2px
    }

    .horse-detail[_ngcontent-uhn-c91] .country-name[_ngcontent-uhn-c91] label[_ngcontent-uhn-c91] div[_ngcontent-uhn-c91]:last-child {
      width: calc(100% - 50px);
      display: flex;
      flex-wrap: wrap;
      align-items: center;
    ...
    .horse-detail[_ngcontent-uhn-c91] .country-name[_ngcontent-uhn-c91] label[_ngcontent-uhn-c91] div[_ngcontent-uhn-c91]:last-child>span[_ngcontent-uhn-c91]:first-child {
      font-weight: 700;
      float: left;
      width: 100%
    }

    .horse-detail[_ngcontent-uhn-c91] .country-name[_ngcontent-uhn-c91] label[_ngcontent-uhn-c91] .jockey-detail[_ngcontent-uhn-c91] {
      font-size: 14px;
      margin-top: 0;
      flex-wrap: wrap;
    ...
    .horse-time-detail[_ngcontent-uhn-c91] {
      display: flex;
      flex-wrap: wrap;
      padding: 5px 5px 0
    }

    .horse-time-detail[_ngcontent-uhn-c91] a[_ngcontent-uhn-c91] {
      display: flex
    }

    .horse-time-detail[_ngcontent-uhn-c91] span[_ngcontent-uhn-c91] {
    ...
    .horse-time-detail[_ngcontent-uhn-c91] span.active[_ngcontent-uhn-c91] {
      position: relative
    }

    .horse-time-detail[_ngcontent-uhn-c91] span.active[_ngcontent-uhn-c91]:before {
      content: "";
      position: absolute;
      left: 0;
      top: 0;
    ...
    .horse-detail[_ngcontent-uhn-c91] .suspended[_ngcontent-uhn-c91]:after {
    ...
    .horse-detail[_ngcontent-uhn-c91] .horse-attr[_ngcontent-uhn-c91] {
      background: #ebe7e7;
    ...
    .horse-detail[_ngcontent-uhn-c91] .table-row[_ngcontent-uhn-c91] .box-1[_ngcontent-uhn-c91] {
      display: flex;
      flex-wrap: wrap;
      justify-content: center;
      align-items: center;
    ...
    .horse-detail[_ngcontent-uhn-c91] .custom-checkbox[_ngcontent-uhn-c91] .custom-control-label[_ngcontent-uhn-c91]:before {
      border-radius: .25rem;
      background: #ddd
    }

    .horse-detail[_ngcontent-uhn-c91] .Lay_oddsbox[_ngcontent-uhn-c91],
    .horse-detail[_ngcontent-uhn-c91] .back_oddsbox[_ngcontent-uhn-c91] {
      height: 100%;
      display: flex;
      align-items: center;
      justify-content: center;
    ...
    .nav-item[_ngcontent-uhn-c91] {
      width: 33.33% !important
    }

    @media (min-width: 767px) {
      .d-none-desktop[_ngcontent-uhn-c91] {
        display: none
      }
    }
    ...
    @media (max-width: 767px) {
      ...
      .horse-detail.d-none-desktop[_ngcontent-uhn-c91] {
        display: inline-flex;
        margin-bottom: 2px
      }

      .d-none-mobile[_ngcontent-uhn-c91] {
        display: none
      }
  ...
  <style>
    input[_ngcontent-uhn-c87]::-webkit-inner-spin-button,
    input[_ngcontent-uhn-c87]::-webkit-outer-spin-button {
      -webkit-appearance: none;
      margin: 0
    }

    input[type=number][_ngcontent-uhn-c87] {
      -moz-appearance: textfield
    }

    #overlay[_ngcontent-uhn-c87] {
      position: absolute;
      top: 0;
      left: 0;
      right: 0;
    ...
    .bet-slip-container[_ngcontent-uhn-c87] {
      position: relative
    }

    .bet-input.lay-border[_ngcontent-uhn-c87]:before {
    ...
    @media (max-width: 767px) {
      ...
      button[_ngcontent-uhn-c87],
      input[_ngcontent-uhn-c87] {
  ...
  <style>
    [_nghost-uhn-c35] .nav-tabs[_ngcontent-uhn-c35] .nav-item.disabled[_ngcontent-uhn-c35] a.disabled[_ngcontent-uhn-c35] {
      cursor: default
    }
  </style>
  <style>
    .scorecard-row[_ngcontent-uhn-c89] .row5[_ngcontent-uhn-c89] .col-6[_ngcontent-uhn-c89]:last-child {
      text-align: right
    }

    .bold[_ngcontent-uhn-c89] {
      font-weight: 400
    }

    body[_ngcontent-uhn-c89] {
      display: flex;
      justify-content: center
    }

    .widgets[_ngcontent-uhn-c89] {
      width: 100%
    }

    .sr-widget[_ngcontent-uhn-c89] {
      border: 1px solid #0000001f;
      margin-bottom: 24px
    }

    .sr-widget-title[_ngcontent-uhn-c89] {
      font-weight: 700;
      padding-bottom: 4px
    }

    .ball-runs[_ngcontent-uhn-c89] {
      display: inline-block;
      height: 25px;
      width: 25px;
      line-height: 25px;
    ...
    .ball123[_ngcontent-uhn-c89] {
      background-color: #48a23c
    }

    .ball0[_ngcontent-uhn-c89] {
      background-color: #999
    }

    .ball45[_ngcontent-uhn-c89] {
      background-color: #66b2ff
    }

    .ballNo[_ngcontent-uhn-c89] {
      background-color: #c2ad7b
    }

    .ballw[_ngcontent-uhn-c89] {
      background-color: #c9362b
    }

    .ball6[_ngcontent-uhn-c89] {
      background-color: #883997
    }

    .ball[_ngcontent-uhn-c89] {
      background-color: #087f23
    }

    .team-score[_ngcontent-uhn-c89] {
      display: flex;
      align-items: center;
      justify-content: space-between
    }

    .required-run[_ngcontent-uhn-c89] {
      color: #c8bfbf
    }
  ...
  <style>
    .text-custom[_ngcontent-uhn-c78] {
      color: #fff
    }

    .loader[_ngcontent-uhn-c78] {
      min-height: 100px;
      position: relative
    }

    #overlay[_ngcontent-uhn-c78] {
      display: flex;
      align-items: center;
      justify-content: center;
      position: fixed;
    ...
    .dots-circle-spinner[_ngcontent-uhn-c78] {
      display: inline-block;
      height: 1em;
      width: 1em;
      line-height: 1;
    ...
    .dots-circle-spinner.loading[_ngcontent-uhn-c78] {
      transform: scale(.5);
      opacity: 1;
  ...
  <app-root _nghost-uhn-c12="" ng-version="12.1.5"><router-outlet _ngcontent-uhn-c12=""></router-outlet><app-layout _nghost-uhn-c75=""><app-topnav _nghost-uhn-c72="">
        <div class="topbar">
          <div class="container-fluid">
            <div class="row">
              <div class="col-md-4 col-4 d-flex"><a class="homelogo" href="{{route('client-home')}}"><i class="fa fa-home"></i><img _ngcontent-uhn-c72="" class="logo-login" src="https://newsilver.art/public/assets/logologin.png"><!----></a></div>
              ...
              <div class="col-12 d-block d-sm-none">
                <div class="searchM"><!----><input type="text" placeholder="Search Here ..." typeaheadoptionfield="name" class="input ng-untouched ng-pristine ng-valid" aria-expanded="false" aria-autocomplete="list"><!---->
        ...
        @include('client.cricbuz-header-menu')
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                <div style="box-shadow: 0px 0px 5px; padding: 10px;">
                  <h2 _ngcontent-uhn-c72="">Dear Client,</h2>
                ...
                <div class="mt-5 font-hindi" style="box-shadow: 0px 0px 5px; padding: 10px;">
                  <h2 _ngcontent-uhn-c72="">प्रिय ग्राहक,</h2>
      ...
      <main _ngcontent-uhn-c75="" id="main">
        <div class="row mx-0">
          <div class="col-md-2 sidebar"><app-sidebar>

              @include('client.cricbuz-sidebar-menu')

            </app-sidebar></div>
          <div class="w-100 d-flex flex-nowrap overflow-auto gap-2 pt-1 pb-1 top-nav-event d-md-none"><span class="text-nowrap d-flex flex-nowrap gap-2 justify-content-between align-items-center text-white bg-dark p-2 rounded"><!----><!----><!----><svg _ngcontent-uhn-c75="" fill="white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1022 1013" class="icon-blink" style="height: 14px;">
              ...
              </svg><!----><span class="blink" style="font-size: 13px;">Sunrisers Hyderabad v
                Lucknow Super Giants</span></span><!----><span class="text-nowrap d-flex flex-nowrap gap-2 justify-content-between align-items-center text-white bg-dark p-2 rounded"><!----><!----><svg _ngcontent-uhn-c75="" fill="white" xmlns="http://www.w3.org/2000/svg" viewBox="-0.1 -0.1 1024.1 1024.1" class="icon-blink" style="height: 14px;">
              ...
              </svg><!----><!----><span class="blink" style="font-size: 13px;">Maximilian Marterer
                v Flavio Cobolli</span></span><!----><span class="text-nowrap d-flex flex-nowrap gap-2 justify-content-between align-items-center text-white bg-dark p-2 rounded"><!----><!----><svg _ngcontent-uhn-c75="" fill="white" xmlns="http://www.w3.org/2000/svg" viewBox="-0.1 -0.1 1024.1 1024.1" class="icon-blink" style="height: 14px;">
                <path d="M874 150q-39-39-83-67-44-29-92-48T601 8q-51-9-101-8l208 209q52 51 77 117 26 65 26 132.5T785 591q-26 65-77 116-52 52-117 78t-132.5 26Q391 811 326 785q-65-25-117-77L0 500q-1 50 8 101 8 50 27 98t48 92q28 44 67 83 75 75 169 113 95 37 193 37t193-37q94-38 169-113t113-169q37-95 37-193t-37-193q-38-94-113-169zM264 653q39 38 89 59t105 20q55 0 105-20.5t89-59.5q39-39 59.5-89T732 458q1-55-20-105t-59-89L401 12q-69 15-133 49.5T150 150q-54 54-88.5 118T12 401l252 252z">
                </path>
              </svg><!----><!----><span class="blink" style="font-size: 13px;">Dolehide v
                Pera</span></span><!----><span class="text-nowrap d-flex flex-nowrap gap-2 justify-content-between align-items-center text-white bg-dark p-2 rounded"><!----><!----><svg _ngcontent-uhn-c75="" fill="white" xmlns="http://www.w3.org/2000/svg" viewBox="-0.1 -0.1 1024.1 1024.1" class="icon-blink" style="height: 14px;">
                <path d="M874 150q-39-39-83-67-44-29-92-48T601 8q-51-9-101-8l208 209q52 51 77 117 26 65 26 132.5T785 591q-26 65-77 116-52 52-117 78t-132.5 26Q391 811 326 785q-65-25-117-77L0 500q-1 50 8 101 8 50 27 98t48 92q28 44 67 83 75 75 169 113 95 37 193 37t193-37q94-38 169-113t113-169q37-95 37-193t-37-193q-38-94-113-169zM264 653q39 38 89 59t105 20q55 0 105-20.5t89-59.5q39-39 59.5-89T732 458q1-55-20-105t-59-89L401 12q-69 15-133 49.5T150 150q-54 54-88.5 118T12 401l252 252z">
                </path>
              </svg><!----><!----><span class="blink" style="font-size: 13px;">Karolina
                Schmiedlova v A Sasnovich</span></span><!----><span class="text-nowrap d-flex flex-nowrap gap-2 justify-content-between align-items-center text-white bg-dark p-2 rounded"><!----><!----><svg _ngcontent-uhn-c75="" fill="white" xmlns="http://www.w3.org/2000/svg" viewBox="-0.1 -0.1 1024.1 1024.1" class="icon-blink" style="height: 14px;">
                <path d="M874 150q-39-39-83-67-44-29-92-48T601 8q-51-9-101-8l208 209q52 51 77 117 26 65 26 132.5T785 591q-26 65-77 116-52 52-117 78t-132.5 26Q391 811 326 785q-65-25-117-77L0 500q-1 50 8 101 8 50 27 98t48 92q28 44 67 83 75 75 169 113 95 37 193 37t193-37q94-38 169-113t113-169q37-95 37-193t-37-193q-38-94-113-169zM264 653q39 38 89 59t105 20q55 0 105-20.5t89-59.5q39-39 59.5-89T732 458q1-55-20-105t-59-89L401 12q-69 15-133 49.5T150 150q-54 54-88.5 118T12 401l252 252z">
                </path>
              </svg><!----><!----><span class="blink" style="font-size: 13px;">Taylo Townsend v
                Bre Fruhvirtova</span></span><!----><span class="text-nowrap d-flex flex-nowrap gap-2 justify-content-between align-items-center text-white bg-dark p-2 rounded"><!----><!----><svg _ngcontent-uhn-c75="" fill="white" xmlns="http://www.w3.org/2000/svg" viewBox="-0.1 -0.1 1024.1 1024.1" class="icon-blink" style="height: 14px;">
                <path d="M874 150q-39-39-83-67-44-29-92-48T601 8q-51-9-101-8l208 209q52 51 77 117 26 65 26 132.5T785 591q-26 65-77 116-52 52-117 78t-132.5 26Q391 811 326 785q-65-25-117-77L0 500q-1 50 8 101 8 50 27 98t48 92q28 44 67 83 75 75 169 113 95 37 193 37t193-37q94-38 169-113t113-169q37-95 37-193t-37-193q-38-94-113-169zM264 653q39 38 89 59t105 20q55 0 105-20.5t89-59.5q39-39 59.5-89T732 458q1-55-20-105t-59-89L401 12q-69 15-133 49.5T150 150q-54 54-88.5 118T12 401l252 252z">
                </path>
              </svg><!----><!----><span class="blink" style="font-size: 13px;">Nuno Borges v Pedro
                Martinez</span></span><!----><span class="text-nowrap d-flex flex-nowrap gap-2 justify-content-between align-items-center text-white bg-dark p-2 rounded"><!----><!----><svg _ngcontent-uhn-c75="" fill="white" xmlns="http://www.w3.org/2000/svg" viewBox="-0.1 -0.1 1024.1 1024.1" class="icon-blink" style="height: 14px;">
                <path d="M874 150q-39-39-83-67-44-29-92-48T601 8q-51-9-101-8l208 209q52 51 77 117 26 65 26 132.5T785 591q-26 65-77 116-52 52-117 78t-132.5 26Q391 811 326 785q-65-25-117-77L0 500q-1 50 8 101 8 50 27 98t48 92q28 44 67 83 75 75 169 113 95 37 193 37t193-37q94-38 169-113t113-169q37-95 37-193t-37-193q-38-94-113-169zM264 653q39 38 89 59t105 20q55 0 105-20.5t89-59.5q39-39 59.5-89T732 458q1-55-20-105t-59-89L401 12q-69 15-133 49.5T150 150q-54 54-88.5 118T12 401l252 252z">
                </path>
              </svg><!----><!----><span class="blink" style="font-size: 13px;">Pavel Kotov v Alex
                Michelsen</span></span><!----><span class="text-nowrap d-flex flex-nowrap gap-2 justify-content-between align-items-center text-white bg-dark p-2 rounded"><!----><!----><svg _ngcontent-uhn-c75="" fill="white" xmlns="http://www.w3.org/2000/svg" viewBox="-0.1 -0.1 1024.1 1024.1" class="icon-blink" style="height: 14px;">
                <path d="M874 150q-39-39-83-67-44-29-92-48T601 8q-51-9-101-8l208 209q52 51 77 117 26 65 26 132.5T785 591q-26 65-77 116-52 52-117 78t-132.5 26Q391 811 326 785q-65-25-117-77L0 500q-1 50 8 101 8 50 27 98t48 92q28 44 67 83 75 75 169 113 95 37 193 37t193-37q94-38 169-113t113-169q37-95 37-193t-37-193q-38-94-113-169zM264 653q39 38 89 59t105 20q55 0 105-20.5t89-59.5q39-39 59.5-89T732 458q1-55-20-105t-59-89L401 12q-69 15-133 49.5T150 150q-54 54-88.5 118T12 401l252 252z">
                </path>
              </svg><!----><!----><span class="blink" style="font-size: 13px;">Luciano Darderi v
                Denis Shapovalov</span></span><!----><span class="text-nowrap d-flex flex-nowrap gap-2 justify-content-between align-items-center text-white bg-dark p-2 rounded"><!----><!----><svg _ngcontent-uhn-c75="" fill="white" xmlns="http://www.w3.org/2000/svg" viewBox="-0.1 -0.1 1024.1 1024.1" class="icon-blink" style="height: 14px;">
                <path d="M874 150q-39-39-83-67-44-29-92-48T601 8q-51-9-101-8l208 209q52 51 77 117 26 65 26 132.5T785 591q-26 65-77 116-52 52-117 78t-132.5 26Q391 811 326 785q-65-25-117-77L0 500q-1 50 8 101 8 50 27 98t48 92q28 44 67 83 75 75 169 113 95 37 193 37t193-37q94-38 169-113t113-169q37-95 37-193t-37-193q-38-94-113-169zM264 653q39 38 89 59t105 20q55 0 105-20.5t89-59.5q39-39 59.5-89T732 458q1-55-20-105t-59-89L401 12q-69 15-133 49.5T150 150q-54 54-88.5 118T12 401l252 252z">
                </path>
              </svg><!----><!----><span class="blink" style="font-size: 13px;">Maks Kasnikowski v
                Nick Hardt</span></span><!----><span class="text-nowrap d-flex flex-nowrap gap-2 justify-content-between align-items-center text-white bg-dark p-2 rounded"><!----><!----><svg _ngcontent-uhn-c75="" fill="white" xmlns="http://www.w3.org/2000/svg" viewBox="-0.1 -0.1 1024.1 1024.1" class="icon-blink" style="height: 14px;">
                <path d="M874 150q-39-39-83-67-44-29-92-48T601 8q-51-9-101-8l208 209q52 51 77 117 26 65 26 132.5T785 591q-26 65-77 116-52 52-117 78t-132.5 26Q391 811 326 785q-65-25-117-77L0 500q-1 50 8 101 8 50 27 98t48 92q28 44 67 83 75 75 169 113 95 37 193 37t193-37q94-38 169-113t113-169q37-95 37-193t-37-193q-38-94-113-169zM264 653q39 38 89 59t105 20q55 0 105-20.5t89-59.5q39-39 59.5-89T732 458q1-55-20-105t-59-89L401 12q-69 15-133 49.5T150 150q-54 54-88.5 118T12 401l252 252z">
                </path>
              </svg><!----><!----><span class="blink" style="font-size: 13px;">Filip Misolic v Ugo
                Blanchet</span></span><!----><span class="text-nowrap d-flex flex-nowrap gap-2 justify-content-between align-items-center text-white bg-dark p-2 rounded"><!----><!----><svg _ngcontent-uhn-c75="" fill="white" xmlns="http://www.w3.org/2000/svg" viewBox="-0.1 -0.1 1024.1 1024.1" class="icon-blink" style="height: 14px;">
                <path d="M874 150q-39-39-83-67-44-29-92-48T601 8q-51-9-101-8l208 209q52 51 77 117 26 65 26 132.5T785 591q-26 65-77 116-52 52-117 78t-132.5 26Q391 811 326 785q-65-25-117-77L0 500q-1 50 8 101 8 50 27 98t48 92q28 44 67 83 75 75 169 113 95 37 193 37t193-37q94-38 169-113t113-169q37-95 37-193t-37-193q-38-94-113-169zM264 653q39 38 89 59t105 20q55 0 105-20.5t89-59.5q39-39 59.5-89T732 458q1-55-20-105t-59-89L401 12q-69 15-133 49.5T150 150q-54 54-88.5 118T12 401l252 252z">
                </path>
              </svg><!----><!----><span class="blink" style="font-size: 13px;">Marco Cecchinato v
                Franco Agamenone</span></span><!----><!----></div><!---->
          ...
          <div class="col-md-10 pxxs-0"><router-outlet _ngcontent-uhn-c75=""></router-outlet><app-sport-detail _nghost-uhn-c91="">
              <div class="wrapper-inner detail_screen">
                <div>
                  <div class="row">
                    <div class="col-md-8 mobile-sec ds-block-mobile listing_screen">
                      <tabset class="odds_matched_tv tab-container" _nghost-uhn-c35="">
                        <ul role="tablist" class="nav nav-tabs" aria-label="Tabs">
                          <li class="active nav-item"><a _ngcontent-uhn-c35="" href="javascript:void(0);" role="tab" class="nav-link active" aria-controls="" aria-selected="true" id=""><span _ngcontent-uhn-c35="">ODDS</span><!----><!----></a></li>
                          <li class="nav-item"><a _ngcontent-uhn-c35="" href="javascript:void(0);" role="tab" class="nav-link" aria-controls="" aria-selected="false" id=""><span _ngcontent-uhn-c35=""></span> MATCHED BET(0) <!----><!----></a></li><!---->
                        </ul>
...
@endphp
                      ...
                      <div id="scoreCard" class="multi-collapse scoreCard_game">
                        <div class="col-12 px-0"><app-score-card _ngcontent-uhn-c91="" _nghost-uhn-c89=""><!----></app-score-card></div>
                      </div><!---->
                      <div class="row">
                        <div class="col-md-12">
                          <div>
                            <h4 _ngcontent-uhn-c91="" class="panel-title"> Match Odds <!----><!----></h4>
                              ...
                              <div class="odds_rows">
                                ...
                                <div class="odds_bhav">
                                  ...
                                  <div class="back_oddsbox bhav_box">
                                    <strong _ngcontent-uhn-c91="" class="odds ng-binding bet_text" data-back-lay="back" data-match-id="{{$r['id']}}" data-team-name="{{$r['team_name']}}">{{$r['back_value']}}</strong>
                                    <div class="size"><span _ngcontent-uhn-c91="" class="ng-binding"> 244.82 </span></div>
                                  </div>
                                  @else
                                  ...
                                  <div class="Lay_oddsbox bhav_box">
                                    <strong _ngcontent-uhn-c91="" class="odds ng- bet_text" data-back-lay="lay" data-match-id="{{$r['id']}}" data-team-name="{{$r['team_name']}}">{{$r['lay_value']}}</strong>
                                    <div class="size"><span _ngcontent-uhn-c91="" class="ng-binding"> 8145.17 </span></div>
                                  </div><!----><!---->
                                  @else
                        ...
                        <div><!---->
                          <div class="row only_bm ctm_bm_mbm">
                            <div class="col-md-8">
                              <h4 _ngcontent-uhn-c91="" class="panel-title"> BOOKMAKER <!----><!----></h4>
                              <div class="body-odds th-bl">
                                <div class="events_odds">&nbsp;&nbsp;</div>
                                <div class="odds_bhav">
                                  <div class="back_oddsbox bhav_box">Back</div>
                              ...
                              <div class="randerScore mainScore">
                                <div class="odds_rows">
                                  ...
                                  <div class="odds_bhav">
                                    @if($r['back_status']==1)
                                    <div class="back_oddsbox bhav_box"><strong _ngcontent-uhn-c91="" class="odds ng-binding bet_text" data-back-lay="back" data-match-id="{{$r['id']}}" data-team-name="{{$r['team_name']}}">{{$r['back_value']}}</strong>
                                      <div class="size"><span _ngcontent-uhn-c91="" class="ng-binding"> </span></div>
                                    </div>
                                    @else
                                    <div style="background:white !important;" class="back_oddsbox bhav_box">
                                    </div>
                                    ...
                                    @if($r['lay_status']==1)
                                    <div class="Lay_oddsbox bhav_box"><strong _ngcontent-uhn-c91="" class="odds ng-binding bet_text" data-back-lay="lay" data-match-id="{{$r['id']}}" data-team-name="{{$r['team_name']}}"> {{$r['lay_value']}} </strong>
                                      <div class="size"><span _ngcontent-uhn-c91="" class="ng-binding"> </span></div>
                                    </div><!----><!---->
                                    @else
                                    <div style="background:white !important;" class="Lay_oddsbox bhav_box">
                            ...
                            <div class="col-md-4">
                              <h4 _ngcontent-uhn-c91="" class="panel-title"> To Win The Toss <!----><!----></h4>
                              <div class="body-odds th-bl">
                                <div class="events_odds">&nbsp;&nbsp;</div>
                                <div class="odds_bhav">
                                  <div class="back_oddsbox bhav_box">Back</div>
                              ...
                              <div class="randerScore mainScore">
                                <div class="odds_rows">
                                  ...
                                  <div class="odds_bhav">
                                    ...
                                    @if($r['lay_status']==1)
                                    <div class="Lay_oddsbox bhav_box"><strong _ngcontent-uhn-c91="" class="odds ng-binding bet_text" data-back-lay="lay" data-match-id="{{$r['id']}}" data-team-name="{{$r['team_name']}}">{{$r['lay_value']}}</strong>
                                      <div class="size"><span _ngcontent-uhn-c91="" class="ng-binding"> 0.0 </span></div>
                                    </div><!----><!---->
                                    @else
                                    <div style="background:white !important;" class="Lay_oddsbox bhav_box">
                                    </div><!----><!---->
                        ...
                        <div class="col-md-6"><!----><!---->
                          <div>
                            <h4 _ngcontent-uhn-c91="" class="panel-title"> Fancy </h4>
                            <div class="body-odds th-bl">
                              <div class="events_odds">&nbsp;&nbsp;</div>
                              ...
                              <div class="randerScore mainScore">
                                <div class="odds_rows">
                                  <div class="events_odds">
                                    <div class="event-names">
                                      <div class="horse-event">
                                        <div class="slogen-horce"><span _ngcontent-uhn-c91="" class="team-horce hyper-text team_name">{{$r['team_name']}}</span></div>
                                      </div>
                                      <div><!----></div>
                                    </div><!----><!---->
                                  </div>
                                  <div class="odds_bhav twoSectionBhavRow">
                                    @if($r['lay_status']==1)
                                    <div class="Lay_oddsbox bhav_box"><strong _ngcontent-uhn-c91="" class="odds ng-binding bet_text" data-back-lay="lay" data-match-id="{{$r['id']}}" data-team-name="{{$r['team_name']}}">{{$r['lay_value']}}</strong>
                                      <div class="size"><span _ngcontent-uhn-c91="" class="ng-binding"> 44 </span></div>
                                    </div>
                                    @else
                                    <div style="background:white !important;" class="Lay_oddsbox bhav_box">
                                    </div>
                                    ...
                                    @if($r['back_status']==1)
                                    <div class="back_oddsbox bhav_box"><strong _ngcontent-uhn-c91="" class="odds ng-binding bet_text" data-back-lay="back" data-match-id="{{$r['id']}}" data-team-name="{{$r['team_name']}}">{{$r['back_value']}}</strong>
                                      <div class="size"><span _ngcontent-uhn-c91="" class="ng-binding">41 </span></div>
                                    </div><!----><!---->
                                    @else
                                    <div style="background:white !important;" class="back_oddsbox bhav_box">
                                    </div><!----><!---->
                        ...
                        <div class="col-md-6"><!----><!---->
                          <div>
                            <h4 _ngcontent-uhn-c91="" class="panel-title"> Run Bhav </h4>
                            <div class="body-odds th-bl">
                              <div class="events_odds">&nbsp;&nbsp;</div>
                              <div class="odds_bhav twoSectionBhavRow">
                                <div class="Lay_oddsbox bhav_box">No</div>
                              ...
                              <div class="randerScore mainScore">
                                <div class="odds_rows">
                                  ...
                                  <div class="odds_bhav twoSectionBhavRow">
                                    @if($r['lay_status']==1)
                                    <div class="Lay_oddsbox bhav_box"><strong _ngcontent-uhn-c91="" class="odds ng-binding bet_text" data-back-lay="lay" data-match-id="{{$r['id']}}" data-team-name="{{$r['team_name']}}">{{$r['lay_value']}}</strong>
                                      <div class="size"><span _ngcontent-uhn-c91="" class="ng-binding"> 103 </span></div>
                                    </div>
                                    @else
                                    <div style="background:white !important;" class="Lay_oddsbox bhav_box">
                                    </div>
                                    ...
                                    @if($r['back_status']==1)
                                    <div class="back_oddsbox bhav_box"><strong _ngcontent-uhn-c91="" class="odds ng-binding bet_text" data-back-lay="back" data-match-id="{{$r['id']}}" data-team-name="{{$r['team_name']}}">{{$r['back_value']}}</strong>
                                      <div class="size"><span _ngcontent-uhn-c91="" class="ng-binding">97 </span></div>
                                    </div><!----><!---->
                                    @else
                                    <div style="background:white !important;" class="back_oddsbox bhav_box">
                                    </div><!----><!---->
                        ...
                        <div class="col-md-6"><!----><!---->
                          <div>
                            <h4 _ngcontent-uhn-c91="" class="panel-title"> Over by Over Session Market </h4>
                            <div class="body-odds th-bl">
                              <div class="events_odds">&nbsp;&nbsp;</div>
                              <div class="odds_bhav twoSectionBhavRow">
                                <div class="Lay_oddsbox bhav_box">No</div>
                              ...
                              <div class="randerScore mainScore">
                                <div class="odds_rows">
                                  ...
                                  <div class="odds_bhav twoSectionBhavRow">
                                    @if($r['lay_status']==1)
                                    <div class="Lay_oddsbox bhav_box"><strong _ngcontent-uhn-c91="" class="odds ng-binding bet_text" data-back-lay="lay" data-match-id="{{$r['id']}}" data-team-name="{{$r['team_name']}}">{{$r['lay_value']}}</strong>
                                      <div class="size"><span _ngcontent-uhn-c91="" class="ng-binding"> 100 </span></div>
                                    </div>
                                    @else
                                    <div style="background:white !important;" class="Lay_oddsbox bhav_box">
                                    </div>
                        ...
                        <div class="col-md-6"><!----><!---->
                          <div>
                            <h4 _ngcontent-uhn-c91="" class="panel-title"> Ball by Ball Session Market </h4>
                            <div class="body-odds th-bl">
                              <div class="events_odds">&nbsp;&nbsp;</div>
                              <div class="odds_bhav twoSectionBhavRow">
                                <div class="Lay_oddsbox bhav_box">No</div>
                              ...
                              <div class="randerScore mainScore">
                                <div class="odds_rows">
                                  ...
                                  <div class="odds_bhav twoSectionBhavRow">
                                    @if($r['lay_status']==1)
                                    <div class="Lay_oddsbox bhav_box"><strong _ngcontent-uhn-c91="" class="odds ng-binding bet_text" data-back-lay="lay" data-match-id="{{$r['id']}}" data-team-name="{{$r['team_name']}}">{{$r['lay_value']}}</strong>
                                      <div class="size"><span _ngcontent-uhn-c91="" class="ng-binding"> 200 </span></div>
                                    </div>
                                    @else
                                    <div style="background:white !important;" class="Lay_oddsbox bhav_box">
                                    </div>
                                    ...
                                    @if($r['back_status']==1)
                                    <div class="back_oddsbox bhav_box"><strong _ngcontent-uhn-c91="" class="odds ng-binding bet_text" data-back-lay="back" data-match-id="{{$r['id']}}" data-team-name="{{$r['team_name']}}">{{$r['back_value']}}</strong>
                                      <div class="size"><span _ngcontent-uhn-c91="" class="ng-binding">130 </span></div>
                                    </div><!----><!---->
                                    @else
                                    <div style="background:white !important;" class="back_oddsbox bhav_box">
                                    </div><!----><!---->
                        ...
                        <div class="col-md-12">
                          <div>
                            <h4 _ngcontent-uhn-c91="" class="panel-title"> Tied Match <!----><span _ngcontent-uhn-c91=""> Maximum Bet 1 &nbsp; <i _ngcontent-uhn-c91="" class="fa fa-info-circle"></i></span><!----></h4>
                            <div class="body-odds th-bl">
                              <div class="events_odds">&nbsp;&nbsp;</div>
                              <div class="odds_bhav">
                                <div class="back_oddsbox bhav_box">Back</div>
                            ...
                            <div class="randerScore mainScore">
                              <div class="odds_rows">
                                ...
                                <div class="odds_bhav">
                                  @if($r['back_status']==1)
                                  <div class="back_oddsbox bhav_box"><strong _ngcontent-uhn-c91="" class="odds ng-binding bet_text" data-back-lay="back" data-match-id="{{$r['id']}}" data-team-name="{{$r['team_name']}}">{{$r['back_value']}}</strong>
                                    <div class="size"><span _ngcontent-uhn-c91="" class="ng-binding"> 407.96 </span></div>
                                  </div>
                                  @else
                                  <div style="background:white !important;" class="back_oddsbox bhav_box">
                                  </div>
                                  ...
                                  @if($r['lay_status']==1)
                                  <div class="Lay_oddsbox bhav_box"><strong _ngcontent-uhn-c91="" class="odds ng-binding bet_text" data-back-lay="lay" data-match-id="{{$r['id']}}" data-team-name="{{$r['team_name']}}">{{$r['lay_value']}}</strong>
                                    <div class="size"><span _ngcontent-uhn-c91="" class="ng-binding"> 252.62 </span></div>
                                  </div><!----><!---->
                                  @else
                                  <div style="background:white !important;" class="Lay_oddsbox bhav_box">
                                  </div><!----><!---->
                        ...
                        <div><!----><!----><!---->
                          <div class="listing_screen">
                            <tabset _nghost-uhn-c35="" class="tab-container">
                              <ul role="tablist" class="nav nav-tabs" aria-label="Tabs">
                                <li class="active nav-item"><a _ngcontent-uhn-c35="" href="javascript:void(0);" role="tab" class="nav-link active" aria-controls="" aria-selected="true" id=""><span _ngcontent-uhn-c35="">Fancy
                                      1</span><!----><!----></a></li>
                                <li class="nav-item"><a _ngcontent-uhn-c35="" href="javascript:void(0);" role="tab" class="nav-link" aria-controls="" aria-selected="false" id=""><span _ngcontent-uhn-c35="">Meter</span><!----><!----></a></li>
                                <li class="nav-item"><a _ngcontent-uhn-c35="" href="javascript:void(0);" role="tab" class="nav-link" aria-controls="" aria-selected="false" id=""><span _ngcontent-uhn-c35="">Khado</span><!----><!----></a></li>
                                <li class="nav-item"><a _ngcontent-uhn-c35="" href="javascript:void(0);" role="tab" class="nav-link" aria-controls="" aria-selected="false" id=""><span _ngcontent-uhn-c35="">Odd
                                      Even</span><!----><!----></a></li>
                                <li class="nav-item"><a _ngcontent-uhn-c35="" href="javascript:void(0);" role="tab" class="nav-link" aria-controls="" aria-selected="false" id=""><span _ngcontent-uhn-c35="">Wicket</span><!----><!----></a></li>
                                <li class="nav-item"><a _ngcontent-uhn-c35="" href="javascript:void(0);" role="tab" class="nav-link" aria-controls="" aria-selected="false" id=""><span _ngcontent-uhn-c35="">Four</span><!----><!----></a></li>
                                <li class="nav-item"><a _ngcontent-uhn-c35="" href="javascript:void(0);" role="tab" class="nav-link" aria-controls="" aria-selected="false" id=""><span _ngcontent-uhn-c35="">Six</span><!----><!----></a>
                                </li>
                                <li class="nav-item"><a _ngcontent-uhn-c35="" href="javascript:void(0);" role="tab" class="nav-link" aria-controls="" aria-selected="false" id=""><span _ngcontent-uhn-c35="">Cricket
                                      Casino</span><!----><!----></a></li><!---->
                              </ul>
                              <div _ngcontent-uhn-c35="" class="tab-content">
                                <tab role="tabpanel" aria-labelledby="" class="tab-pane active">
                                  <div class="row"><!----><!---->
                                    <div class="col-md-12">
                                      <div class="randerScore mainScore">
                                        <div class="no-dt">
                                          <p _ngcontent-uhn-c91="">No real-time records found</p>
                                        </div>
                                      </div>
                                    </div><!---->
                                  </div>
                            ...
                            <div class="back">
                              ...
                              <div class="row border-bottom align-items-center">
                                <div class="col col-md-4 text-left bat_team_place"><a><i _ngcontent-uhn-c87="" class="fa fa-close text-danger"></i></a> Sunrisers
                                  Hyderabad </div>
                                <div class="col"><input type="text" name="bet_odds" id="bet_input" readonly="true" min="1.01" max="999.99" class="form-control ng-untouched ng-pristine ng-valid"></div><!----><!---->
                              ...
                              <div class="row align-items-center">
                                <div class="col"><button type="button" class="btn cancel-btn" id="reset_btn">reset</button></div>
            ...
            <div class="modal-dialog modal-sm">
              <div class="modal-content">
                <div class="modal-header py-1 mobileBetplaceHeader">
                  <h4 _ngcontent-uhn-c91="" id="dialog-static-name" class="modal-title pull-left">Place Bet</h4>
                  <button _ngcontent-uhn-c91="" type="button" data-dismiss="modal" aria-label="Close" class="close"><i _ngcontent-uhn-c91="" class="fa fa-close"></i></button>
                </div>
                <div class="modal-body p-0"><app-bet-slip _ngcontent-uhn-c91="" _nghost-uhn-c87="">
                    <form action="{{route('cricket-bet-place')}}" method="POST">
                      @csrf
                      <div class="betting-table lay-bt" style="position: relative;">
                        <h2 _ngcontent-uhn-c87="" class="mrkname"> place bet </h2>
  ...
  <script>
    ...
    //     @foreach(Session::get('myBets') as $m)
    //     var string = '<tr>';
    //       string += '<td colspan="3" class="text-left">'+{{$m["team_name"]}}+'</td>';
    //       string += '<td colspan="3" class="text-left">'+{{$m["bet_odds"]}}+'</td>';
    //       string += '<td colspan="3" class="text-left">'+{{$m["bet_stake"]}}+'</td>';
    //     string += '</tr>';
    //     @endforeach
    //     $(".my-bet-table").append(string);
    //  @else
    //  var nodata = '<tr>';
    //  nodata += '<td colspan="3" class="text-left text-center">No data Found</td>';
    //  nodata += '</tr>';
