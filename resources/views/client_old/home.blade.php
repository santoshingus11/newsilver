...
@endphp  
                    ...
                    <div class="col-md-1 col-lg-2 col-6 px-lg-0">
                      <div class="game-icons"><span class="game-icon"><span @if($r['status']==1) class="active" @endif></span><!----></span><span class="game-icon"><i class="fa fa-tv v-m icon-tv cursor"></i><!----></span><span class="game-icon"><img src="{{asset('/')}}/assets/img/icons/ic_fancy.png" class="fancy-icon cursor"><!----></span><span class="game-icon"><img src="{{asset('/')}}/assets/img/icons/ic_bm.png" class="bookmaker-icon cursor"><!----></span></div><!---->
                    </div>
