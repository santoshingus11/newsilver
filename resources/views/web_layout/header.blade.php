<app-topnav>
    <div class="topbar">
        <div class="container-fluid">
              ...
              @endif
            <div class="row">
                <div class="col-md-4 col-4 d-flex"><a class="homelogo" href="{{route('client-home')}}"><i class="fa fa-home"></i><img _ngcontent-wcx-c72="" class="logo-login" src="{{asset('/')}}assets/logologin.png"><!----></a></div>
                    ...
                    <div class="collapse navbar-collapse">
                        <ul class="list-unstyled navbar-nav">
                            ...
                            <li class="nav-item"><a href="{{route('client-home')}}"><b>IPL
                                        2024</b></a></li>
                            <li class="nav-item"><a href="https://newsilver.art/slot/game/lounch/9280"><b>One-Day
                                        Teenpatti</b></a></li>
                            <li class="nav-item"><a href="https://newsilver.art/slot/game/lounch/9646"><b>Roulette</b></a></li>
                            ...
                            <li class="nav-item"><a href="https://newsilver.art/slot/game/lounch/9686"><b>Sicbo</b></a></li>
                            <li class="nav-item"><a href="https://newsilver.art/slot/game/lounch/9690"><b>Poker</b></a></li>
                            <li class="nav-item"><a href="https://newsilver.art/slot/game/lounch/12959"><b>Andar
                                        Bahar</b></a></li>
                            <li class="nav-item"><a href="https://newsilver.art/slot/game/lounch/9678"><b>One-Day
                                        Dragon Tiger</b></a></li><!---->
                        </ul><!---->
                    </div>
                </nav>
